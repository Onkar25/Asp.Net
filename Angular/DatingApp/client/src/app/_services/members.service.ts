...
resetParams(){
  ...
  getMembers() {
    ...
    let params = this.setPrivateHeaders(this.userParamss().pageNumber, this.userParamss().pageSize);
  ...
  setPaginationResponse(response: HttpResponse<Member[]>) {
  ...
  private setPrivateHeaders(pageNumber?: number, pageSize?: number) {
